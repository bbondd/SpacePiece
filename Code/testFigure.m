...
% Last Modified by GUIDE v2.5 17-Nov-2017 12:24:32
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
str = get(handles.testEdit, 'String');
set(handles.testEdit, 'String', [str, 'as']);
guidata(hObject, handles);

% --- If Enable == 'on', executes on mouse press in 5 pixel border.
% --- Otherwise, executes on mouse press in 5 pixel border or over testEdit.
function testEdit_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to testEdit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
